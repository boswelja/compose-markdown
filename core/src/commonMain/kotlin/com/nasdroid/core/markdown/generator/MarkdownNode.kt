 ...
 */
internal sealed interface MarkdownSpanNode
 ...
 */
internal data class MarkdownBlockQuote(
 ...
 */
internal data object MarkdownRule : MarkdownNode

/**
 * Represents whitespace in a Markdown Span.
 */
internal data object MarkdownWhitespace : MarkdownSpanNode

/**
 * Represents a line end in a Markdown Span.
 */
internal data object MarkdownEol: MarkdownSpanNode
 ...
 * additional context.
 */
internal data class MarkdownImage(
    val imageUrl: String,
 ...
 */
internal data class MarkdownOrderedList(
 ...
 * @property listItems A list of [MarkdownNode]s this list contains.
 */
internal data class MarkdownUnorderedList(
    val listItems: List<MarkdownListItem>
) : MarkdownNode
 ...
 */
internal data class MarkdownHtmlBlock(
    val text: String
) : MarkdownNode
